...
- VSCodiumin lähdekoodilla ja ohjelmatiedostoilla (binääri) on [MIT-lisenssi](https://github.com/VSCodium/vscodium/blob/master/LICENSE)
  - Microsoftin Visual Studio Marketplacesta hankittujen lisäosien käyttö VSCodiumissa [rikkoo lisenssiä](https://github.com/microsoft/vscode/issues/31168)
...
- VSCodiumin ensimmäinen julkaisu [15.8.2018](https://github.com/VSCodium/vscodium/releases/tag/1.26.0)
